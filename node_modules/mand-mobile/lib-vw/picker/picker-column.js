  ...
  exports.default = {
    ...
    computed: {
      hooks: function hooks() {
        var _hooks = this.$el.querySelectorAll('.md-picker-column-hook');
    ...
    watch: {
      data: {
        handler: function handler(val) {
          this.columnValues = (0, _util.extend)([], val);
        },
    ...
    created: function created() {
      this.columnValues = (0, _util.extend)([], this.data);
    },
    ...
    methods: {
      $_initColumnsScroller: function $_initColumnsScroller() {
        ...
        for (var i = startIndex, len = this.hooks.length; i < len; i++) {
          var container = this.hooks[i];
      ...
      $_initColumnIndex: function $_initColumnIndex() {
        ...
        this.$_getColumnIndexByDefault(data, defaultIndex, defaultValue, function (columnIndex, itemIndex) {
          ...
          if (_this3.$_isColumnIndexInvalid(columnIndex, itemIndex)) {
            _this3.$_scrollToValidIndex(scroller, columnIndex, itemIndex);
          } else {
            _this3.$_scrollToIndex(scroller, columnIndex, itemIndex);
      ...
      $_isColumnIndexActive: function $_isColumnIndexActive(columnIndex, itemIndex) {
        var activeIndex = this.activedIndexs[columnIndex];
      ...
      $_resetScrollingPosition: function $_resetScrollingPosition(columnIndex) {
        var scroller = this.scrollers[columnIndex];
        var columnValue = this.columnValues[columnIndex] || [];
        var oldColumnActiveIndex = this.activedIndexs[columnIndex] || 0;
      ...
      $_scrollToIndex: function $_scrollToIndex(scroller, columnIndex, itemIndex) {
        var offsetTop = this.$_getColumnOffsetByIndex(itemIndex);
        scroller.scrollTo(0, offsetTop);
      },
      $_scrollToValidIndex: function $_scrollToValidIndex(scroller, columnIndex, itemIndex) {
