    ...
    methods: {
      ...
      $_initScroller: function $_initScroller() {
        ...
        var scroller = new _scroller2.default(function (left, top) {
          (0, _render.render)(_this3.$swiper, left, top, 1, _this3.useNativeDriver);
        }, {
          ...
          scrollingComplete: function scrollingComplete() {
            _this3.transitionEndHandler && _this3.transitionEndHandler();
          }
        });
      ...
      $_opacity: function $_opacity() {
        ...
        if (animate) {
          setTimeout(function () {
            _this4.$emit('after-change', _this4.fromIndex, _this4.toIndex);
          }, 500);
        }
      },
      ...
      $_startPlay: function $_startPlay() {
        ...
        if (this.autoplay > 0 && this.oItemCount > 1) {
          ...
          this.timer = setInterval(function () {
            if (!_this5.isLoop && _this5.index >= _this5.rItemCount - 1) {
              return _this5.$_clearTimer();
            }
            if (!_this5.dragging) {
              _this5.next();
            }
      ...
      $_doTransition: function $_doTransition(towards, options) {
        ...
        setTimeout(function () {
          var isFirstItem = _this6.isFirstItem && _this6.isLoop;
          var isLastItem = _this6.isLastItem && _this6.isLoop;
          ...
          _this6.transitionEndHandler = function () {
            ...
            _this6.transitionEndHandler = null;
          };
